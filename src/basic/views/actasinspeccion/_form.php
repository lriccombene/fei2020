...
echo $this->render('/components/ModelForm2');
?>
...
<script>
    ...
    var app = new Vue({
        ...
        data:{
            ...
            fields: ['id',' nro ','fec','localidad','categoria','motivo','empresa','area','latitud','longitud'] , //poner en un array los campos que queres
