    ...
    <div class="container">
        ...
        <table class="table" id="my-table">
            ...
            <tr v-for="(model,key) in models" v-bind:key="model[modelfields[0]]">
                ...
                <td>
                    <button v-on:click="geografiaModel(model[modelfields[10]])" type="button" class="btn btn-danger">Geografia</button>
                </td>
            </tr>
            </tbody>
        </table>
...
<script>
    ...
    const Crud = {
        ...
        methods: {
            ...
            geografiaModel: function () {
                  var self = this; // nos re envia a la vista que crea obejeto del modelo
                  var logitud = self.longitud;
                  window.location.href = "/site/geografia;
            },
