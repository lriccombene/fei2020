...
?>
<a><h1>Envíos de Documentación</h1></a>
...
<script>
    ...
    var app = new Vue({
        ...
        data:{
            ...
            fields: ['id','archivo_urlnotificado','destino','detalle','fec','fec_notificado','relevancia','transporte'] , //poner en un array los campos que queres
