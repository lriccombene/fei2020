 ...
 * - `{{%tipotrabajo}}`
 */
class m200515_215755_create_dictamenestecnicos_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        // creates index for column `id_tipotarbajo`
        $this->createIndex(
            '{{%idx-dictamenestecnicos-id_tipotarbajo}}',
            '{{%dictamenestecnicos}}',
            'id_tipotarbajo'
        );
        ...
        $this->addForeignKey(
            '{{%fk-dictamenestecnicos-id_tipotarbajo}}',
            '{{%dictamenestecnicos}}',
            'id_tipotarbajo',
            '{{%tipotrabajo}}',
            'id',
    ...
    public function safeDown()
    {
        ...
        // drops index for column `id_tipotarbajo`
        $this->dropIndex(
            '{{%idx-dictamenestecnicos-id_tipotarbajo}}',
            '{{%dictamenestecnicos}}'
        );
